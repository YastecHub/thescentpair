...
export function StaticSplitWorld({ pair }: Readonly<{ pair: Pair }>) {
    ...
    <section className="relative overflow-hidden border border-onyx-700 bg-onyx-800" data-motion="two-halves" aria-labelledby="split-world-title">
      <div className="grid lg:grid-cols-[1fr_auto_1fr]">
        <div className="bg-his-500/45 p-5 md:p-8">
          ...
          {his ? <ProductImage media={{ publicId: his.media.heroDark, alt: `${his.name} bottle` }} ratio="4 / 3" className="mt-5" /> : null}
        ...
        <div className="bg-hers-500/45 p-5 md:p-8">
          ...
          {hers ? <ProductImage media={{ publicId: hers.media.heroDark, alt: `${hers.name} bottle` }} ratio="4 / 3" className="mt-5" /> : null}
